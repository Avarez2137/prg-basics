...
class Test(unittest.TestCase):
    ...
    def test_p4(self):
        import p4
        self.assertEqual(p4.f(12,0.9,10),2)
        self.assertEqual(p4.f(10,0.6,1),5)
        self.assertEqual(p4.f(25,0.85,7),8)
        self.assertEqual(p4.f(100,0.8,5),14)

    def test_p5(self):
        import p5
        self.assertEqual(p5.f("09:08:07"),True)
        self.assertEqual(p5.f("15:05:60"),False)
        self.assertEqual(p5.f("15:05:06:07"),False)
        self.assertEqual(p5.f("15-12-10"),False)
